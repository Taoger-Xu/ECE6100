...
void die_usage() {
  ...
  printf("   -bpredpolicy <num>    Set branch predictor  [0:Perfect 1:AlwaysTaken 2:GShare 3:GSelect 4:Tournament]\n");
}
...
int32_t  BPRED_POLICY=-1; // 0:Perfect 1:AlwaysTaken 2: GSharse 3: GSelect 4:Tournament
